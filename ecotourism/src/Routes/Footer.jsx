...
const ListHeader = ({ children }) =>
  ...
  {
    return (
      <Text fontWeight={"800"} fontSize={"lg"} mb={2} color={"whiteAlpha.900"}>
        {children}
      </Text>
    );
  };
...
export default function Footer() {
  ...
  return (
    <Box
      bg="#7DBBA9" //{useColorModeValue('#7DBBA9', 'white')}
      color="whiteAlpha.900" //{useColorModeValue('gray.700', 'gray.200')}
    >
      <Container as={Stack} maxW={"6xl"} py={10}>
        ...
        >
          <Stack spacing={6}>
            <Box ml={-10}>
              <Link to="/"><Logo color={useColorModeValue("gray.700", "white")} /></Link>
            </Box>
          ...
          <Stack align={"flex-start"}>
            ...
            <Stack direction={"row"}>
              ...
              <IconButton
                className="grow"
                bg="#DEB74C"//{useColorModeValue("green.400", "green.800")}
